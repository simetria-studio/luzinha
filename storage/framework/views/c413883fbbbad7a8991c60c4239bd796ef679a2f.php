...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('assets/css/login.min.css')); ?>">
...
<body>
    ...
    <div class="retangulo">
        <div class="logo">
            <img src="<?php echo e(url('assets/img/login.png')); ?>" alt="">
        </div>
...
<?php /**PATH C:\xampp\htdocs\luzinha\resources\views/layouts/login.blade.php ENDPATH**/ ?>