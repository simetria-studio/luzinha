...
Route::get('/livro-1', [SiteController::class, 'lpbomdia'])->middleware('auth');
Route::get('/livro-2', [SiteController::class, 'lphorapapa'])->middleware('auth');
...
Route::post('login/post', [RegisterController::class, 'login']);
